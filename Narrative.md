...
| [12](#entry-fix-unbreak-the-e2e-database-shape-test-and-gate-pull-requests-on-the-su) | 2026-08-29 | fix: unbreak the E2E database-shape test, and gate pull requests on the suite | product | Two changes, one per commit. The test's result shape becomes a class with a parameterless constructor and settable properties, which is the form Playwright's converter can populate. |
...
<a id="entry-fix-unbreak-the-e2e-database-shape-test-and-gate-pull-requests-on-the-su"></a>

## Entry 12 — 2026-08-29 — fix: unbreak the E2E database-shape test, and gate pull requests on the suite
